...
class Model_users extends CI_Model 
{
	...
	function get ( $id, $get_one = false )
	{
	    ...
	    $select_statement = ( $this->raw_data ) ? ",u.id,u.first_name,u.last_name,u.room" : ",u.id,u.first_name,u.last_name,u.room";
...
function lister ( $segments, $perPage )
	{
		...
		$sort_columns = array(',u.id,u.first_name,u.last_name,u.room');
		$sort_by = (in_array($segments['sort_by'], $sort_columns)) ? $segments['sort_by'] : 'id';
	    
	    $this->db->start_cache();
		$this->db->select( ",u.id,u.first_name,u.last_name,u.room", FALSE);
    ...
    {
        $fs = array(
	'search_field' => lang('users.first_name'),
	'id' => lang('users.id'),
	'first_name' => lang('users.first_name'),
	'last_name' => lang('users.last_name'),
	'room' => lang('users.room')
);
